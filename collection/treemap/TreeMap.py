...
class ChineseSort(object):
    ...
    def load_py_dict(self, py_dict_path):
        result = {}
        py_file = open(py_dict_path, 'r',encoding='utf-8')
    ...
    def load_bh_dict(self, bh_dict_path):
        result = {}
        bh_file = open(bh_dict_path, 'r',encoding='utf-8')
...
class TreeMap(object):
    ...
    py_dict_path = Dic_root + 'py.txt'
    bh_dict_path = Dic_root + 'bh.txt'
